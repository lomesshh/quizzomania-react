...
<div className="category">
    <div className="category__one">
        <div className="category__card">
            ...
            <div className="category__button">
                <h5 onClick={() => dispatch(getQuizHandler(navigate, "pmCzn6ogWFaYHUzsX9gF") as any)}>Play now <i className="fa-solid fa-arrow-right"></i></h5>
    ...
    <div className="category__two">
        <div className="category__card">
            ...
            <p>Node.js is an open source server environment. it allows you to run JS on the server.
                 Test your knowledge with this basic React quiz made especially for beginners.</p>
            <div className="category__button">
                <h5 onClick={() => dispatch(getQuizHandler(navigate, "lZpd4rPgBReS6rnpba5O") as any)}>Play now <i className="fa-solid fa-arrow-right"></i></h5>
                <Link to="/leaderboard"><h5>Score board <i className="fa-solid fa-medal"></i></h5></Link>
            </div>
            </div>
        <div className="category__card">
            ...
            <p>JavaScript is a high-level, often just-in-time compiled language.
                 Test your knowledge with this basic React quiz made especially for beginners.</p>
            <div className="category__button">
            <h5 onClick={() => dispatch(getQuizHandler(navigate, "rjDyP5690kGwSCdkdoI8") as any)}>Play now <i className="fa-solid fa-arrow-right"></i></h5>
                <Link to="/leaderboard"><h5>Score board <i className="fa-solid fa-medal"></i></h5></Link>
            </div>
        </div>
    </div>
    <div className="category__three">
        <div className="category__card">
            ...
            <div className="category__button">
            <h5 onClick={() => dispatch(getQuizHandler(navigate, "bhh97Q5YCvQMiTvDAgZe") as any)}>Play now <i className="fa-solid fa-arrow-right"></i></h5>
                <Link to="/leaderboard"><h5>Score board <i className="fa-solid fa-medal"></i></h5></Link>
            </div>
        </div>
    </div>
